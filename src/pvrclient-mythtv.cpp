...
PVR_ERROR PVRClientMythTV::CallRecordingMenuHook(const kodi::addon::PVRMenuhook& menuhook, const kodi::addon::PVRRecording& item)
{
  ...
  if (menuhook.GetHookId() == MENUHOOK_INFO_RECORDING)
  {
    ...
    items[8].append((pf & 0x00001) ? "1 " : "");
    items[8].append((pf & 0x00002) ? "2 " : "");
    items[8].append((pf & 0x00004) ? "3 " : "");
    items[8].append((pf & 0x00008) ? "4 " : "");
    items[8].append((pf & 0x00010) ? "5 " : "");
    items[8].append((pf & 0x00020) ? "6 " : "");
    items[8].append((pf & 0x00040) ? "7 " : "");
    items[8].append((pf & 0x00080) ? "8 " : "");
    items[8].append((pf & 0x00100) ? "9 " : "");
    items[8].append((pf & 0x00200) ? "A " : "");
    items[8].append((pf & 0x00400) ? "B " : "");
    items[8].append((pf & 0x00800) ? "C " : "");
    items[8].append((pf & 0x01000) ? "D " : "");
    items[8].append((pf & 0x02000) ? "E " : "");
    items[8].append((pf & 0x04000) ? "F " : "");
    items[8].append((pf & 0x08000) ? "G " : "");
    items[8].append((pf & 0x10000) ? "H " : "");
    items[8].append((pf & 0x20000) ? "I " : "");
    items[8].append("[/COLOR]");

    items[9].append("AudioProps : [COLOR white]");
    unsigned ap = pinfo.GetPtr()->audioProps;
    items[9].append((ap & 0x001) ? "1 " : "");
    items[9].append((ap & 0x002) ? "2 " : "");
    items[9].append((ap & 0x004) ? "3 " : "");
    items[9].append((ap & 0x008) ? "4 " : "");
    items[9].append((ap & 0x010) ? "5 " : "");
    items[9].append((ap & 0x020) ? "6 " : "");
    items[9].append((ap & 0x040) ? "7 " : "");
    items[9].append((ap & 0x080) ? "8 " : "");
    items[9].append((ap & 0x100) ? "9 " : "");
    items[9].append((ap & 0x200) ? "A " : "");
    items[9].append((ap & 0x400) ? "B " : "");
    items[9].append("[/COLOR]");

    items[10].append("VideoProps : [COLOR white]");
    unsigned vp = pinfo.GetPtr()->videoProps;
    items[10].append((vp & 0x001) ? "1 " : "");
    items[10].append((vp & 0x002) ? "2 " : "");
    items[10].append((vp & 0x004) ? "3 " : "");
    items[10].append((vp & 0x008) ? "4 " : "");
    items[10].append((vp & 0x010) ? "5 " : "");
    items[10].append((vp & 0x020) ? "6 " : "");
    items[10].append((vp & 0x040) ? "7 " : "");
    items[10].append((vp & 0x080) ? "8 " : "");
    items[10].append((vp & 0x100) ? "9 " : "");
    items[10].append((vp & 0x200) ? "A " : "");
    items[10].append((vp & 0x400) ? "B " : "");
